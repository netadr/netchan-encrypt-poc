...
namespace Components
{
	...
	public:
		...
		bool Decrypt(Game::msg_t* msg) const
		{
			...
			if (clen > 0) // If this isn't true something has gone wrong
			{
	...
	private:
		...
		static void DirectConnectDataStub(Game::netsrc_t sock, Game::netadr_t adr, const char* format, int len);
		static void ClientDeriveKey(Game::msg_t* msg);
